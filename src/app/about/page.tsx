    ...
    <>
      ...
      <section className="px-6 md:px-16 py-16 bg-[var(--color-surface)]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 stagger">
            {aboutText.teamMembers.map((member, i) => (
              <div key={i} className="text-center space-y-3">
                <img
                  src={`/images/team-${i + 1}.svg`}
                  alt={`${member.name}大頭貼`}
                ...
                <div>
                  ...
                  <p className="font-[var(--font-en)] text-xs text-[var(--color-muted)] tracking-wider">
                    {member.role}
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 stagger">
            {aboutText.futurePlans.items.map((item, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-8 space-y-3 shadow-[0_2px_8px_0_rgba(0,0,0,0.06)]"
              >
