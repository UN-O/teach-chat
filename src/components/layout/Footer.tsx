      ...
      <div className="max-w-6xl mx-auto px-6 md:px-16 py-16">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="font-[var(--font-body)] text-sm leading-[1.7] text-white/70 max-w-[45ch]">
          ...
          <nav className="space-y-3">
            <p className="font-[var(--font-en)] text-xs font-medium tracking-widest uppercase text-white/50 mb-4">
              Pages
            </p>
            {footerLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="block font-[var(--font-body)] text-sm text-white/70 hover:text-white transition-colors duration-200"
              >
                {link.label}
              </Link>
            ))}
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <p className="font-[var(--font-en)] text-xs text-white/40">
            {navText.footerCopyright}
          </p>
          <a
            href="mailto:contact@teachchat.tw"
            className="font-[var(--font-en)] text-xs text-white/50 hover:text-white transition-colors duration-200"
          >
